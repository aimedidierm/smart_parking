            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                  <?php
                    $sql = "SELECT t.user,t.enter,t.goout,t.amount,t.total,u.id,u.names FROM history AS t JOIN user AS u ON u.id=t.user";
                    $stmt = $db->prepare($sql);
                    $stmt->execute();
                    if ($stmt->rowCount() > 0) {
                        $count = 1;
                  ...
                  <tr>
                    ...
                    <td><?php print $row['enter']?></td>
                    <td><?php print $row['goout']?></td>
